...
import 'package:proyecto/src/pages/aboutUs_page2.dart';
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          _buttonGenerator('Acerca de', '', context,()=>{Navigator.of(context).push(MaterialPageRoute(builder:(context)=>AboutUsPage2()))})
                        ],
                      ),
