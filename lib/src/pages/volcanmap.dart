...
class Volcanmap extends StatefulWidget 
{
...
class _FullScreenMapState extends State<Volcanmap> 
{
    ...
    [
      ...
      FloatingActionButton.extended
        (
          ...
          onPressed: ()=>{Navigator.of(context).push(MaterialPageRoute(builder:(context)=>OptVolcan()))},
          ),
  ...
  MapboxMap crearMapa()
{
  ...
  (       
         // styleString: 'mapbox://styles/billy270/ckh6cpexg1e9v19pn7m7k8x1a',
          ...
          (
            target:LatLng(8.776142, -82.637633),
            zoom: 14, 
          ),
