...
class Bqtmap extends StatefulWidget 
{
...
class _FullScreenMapState extends State<Bqtmap> 
{
    ...
    [
      ...
      FloatingActionButton.extended
        (
          ...
          onPressed: ()=>{Navigator.of(context).push(MaterialPageRoute(builder:(context)=>OptBqt()))},
          ),
  ...
  MapboxMap crearMapa()
{
  ...
  (       
         // styleString: 'mapbox://styles/billy270/ckh6cpexg1e9v19pn7m7k8x1a',
          ...
          (
            target:LatLng(8.781125, -82.432239),
            zoom: 14, 
          ),
